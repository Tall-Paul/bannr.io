...
class ProxyController extends Controller
{
   ...
   protected function proxy_curl($url){
    ...
    public function index($site_id)
    {
        ...
        ",$response);
        $response = str_replace('href="'.$proxy_url,'href="https://'.$site_id.".proxy.bannr.io/",$response);
        $response = str_replace("href='".$proxy_url,"href='https://".$site_id.".proxy.bannr.io/",$response);
        $non_ssl = str_replace('https','http',$proxy_url);
        $response = str_replace('href="'.$non_ssl,'href="https://'.$site_id.".proxy.bannr.io/",$response);
        $response = str_replace("href='".$non_ssl,"href='https://".$site_id.".proxy.bannr.io/",$response);
